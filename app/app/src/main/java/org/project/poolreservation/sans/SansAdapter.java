...
import org.project.poolreservation.Customer_List_Page;
...
public class SansAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.customer_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), Customer_List_Page.class);
                intent.putExtra("token",sans.get(position).getToken());
                intent.putExtra("sectionId",String.valueOf(sans.get(position).getId()));
    ...
    private class ViewHolder  {
        ...
        public ViewHolder(View converview ){
            if(converview!= null) {
                ...
                customer_btn=converview.findViewById(R.id.customerbtn);
            }
