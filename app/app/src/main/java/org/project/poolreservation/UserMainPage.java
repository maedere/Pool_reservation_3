...
public class UserMainPage extends AppCompatActivity {
    ...
    Button reservedbtn;
    RelativeLayout no_pool,have_pool;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_main_page);
        reservedbtn=findViewById(R.id.visitReservedbtn);
        no_pool=findViewById(R.id.no_pool);
        have_pool=findViewById(R.id.has_pool);
        ...
        reservedbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(UserMainPage.this,Customer_Reserved_Page.class);
            ...
            public void onResponse(JSONObject response) {
                ...
                if( response.toString().contains("200")){
                    ...
                    if(has_sans)
                        ...
                        have_pool.setVisibility(View.INVISIBLE);
                        no_pool.setVisibility(View.VISIBLE);
                    }
                }
